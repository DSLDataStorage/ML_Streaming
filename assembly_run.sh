...
if [ ${dis} -eq 0 ];then
	...
	master="spark://192.168.0.15:7077"  #for spark standalone
else 
	master="mesos://192.168.0.15:5050"	#for mesos cluster manager
fi
...
rm -rf final_result
../spark-2.4.4-bin-hadoop2.7/bin/spark-submit --class ds_join.$class --master $master /home/user/Desktop/hongji/Dima_Ds_join/target/scala-2.11/Dima-DS-assembly-1.0.jar $num > log
